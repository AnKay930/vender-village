    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          />
          {errors.phone && (
            <p className="text-red-500 text-sm">{errors.phone.message || "Phone number is required"}</p>
          )}
        </div>
        ...
        <div className="flex gap-4">
          ...
          <div className="w-1/2">
            ...
            />
            {errors.zip && (
              <p className="text-red-500 text-sm">{errors.zip.message || "Postal code is required"}</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="John Doe"
          />
          {errors.cardName && <p className="text-red-500 text-sm">Cardholder name is required</p>}
        </div>
            ...
            <input
              {...register("expiryDate", {
                ...
                validate: (value) => {
                  ...
                  return inputDate >= cutoff || "Expiry date cannot be before April 2025";
                },
              })}
              className="w-full border p-2 rounded mt-1"
              placeholder="MM/YY"
